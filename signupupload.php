...
<body>
            ...
            if ($check == 0)
            {
                ...
                if ($password!="" && $password==$passwordco)
                {
                    if($a<=$letcount12 && $letcount12<=$b)
                    {
                        ...
                        $sql="insert into user set email='$email', name='$name', password='$hashed_password', remark='puzzles', question='$question', answer='$answer'";
    ...
    <section>
        ...
        <p>
            ...
            <form action="signupupload.php" method="post">
                <div>
            ...
            ?>
                <div class="container">
                    <div class="tabs">
                        ...
                        <input type="radio" id="radio-2" name="tabs" onclick="shiftpuzzleinfinite()" />
