            ...
            if ($check == 0)
            {
                ...
                if ($password!="" && $password==$passwordco)
                {
                    if($a<=$letcount12 && $letcount12<=$b)
                    {
                        ...
                        $sql="insert into user set email='$email', name='$name', password='$hashed_password', remark='photos', question='$question', answer='$answer'";
            ...
            <script src="signup.js"></script>
                <div class="container">
                    <div class="tabs">
                        ...
                        <input type="radio" id="radio-2" name="tabs" onclick="shift()" />
